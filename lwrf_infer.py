...
class LwrfInfer:
    def __init__(self, use_cuda, save_path=None):
        ...
        # self.net = rf_lw50(num_classes=10)
        # hard-coded paths
        ...
        # class_map : {0: 'background', 1: 'red', 2: 'orange', 3: 'yellow', 4: 'green', 5: 'blue', 6: 'indigo', 7: 'violet'}
    ...
    def segment(self, img):
        ...
        segm = self.net(img_inp)[0].cpu().detach().numpy().transpose(1, 2, 0) # shape=(120,160,10) ndarray
...
# test
# lwrf_model = LwrfInfer(True)
# color_img = cv2.imread("./clipseg/0.png")
